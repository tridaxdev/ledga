export enum AllowedChannelIpc {
    ...
    TransactionsListAccounts = "transactions:list-accounts",
    TransactionsInvalidated = "transactions:invalidated",
    CategoriesGetAll = "categories:get-all",
    CategoriesCreate = "categories:create",
    CategoriesUpdate = "categories:update",
    CategoriesDelete = "categories:delete",
    AnalyticsGetMonthlyTotals = "analytics:get-monthly-totals",
    AnalyticsGetCategoryTotals = "analytics:get-category-totals",
    AnalyticsGetNetWorthHistory = "analytics:get-net-worth-history",
    AnalyticsListCurrencies = "analytics:list-currencies",
