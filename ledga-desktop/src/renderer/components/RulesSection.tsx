        ...
        <section style={{ marginTop: 32 }}>
            ...
            {isLoading ? (
                ...
                <div style={{ padding: 24, borderRadius: 8, border: '1px dashed var(--color-ledga-border)', textAlign: 'center' }}>
                    <p style={{ margin: 0, fontSize: 14, color: 'var(--color-ledga-text-muted)' }}>
                        No rules yet. Rules auto-categorise and rename matching transactions.
                    </p>
                </div>
            ) : (
            ...
            {formOpen && (
                <div style={{ marginTop: 12, padding: 16, borderRadius: 8, border: '1px solid var(--color-ledga-border)', backgroundColor: 'var(--color-ledga-sidebar)', display: 'flex', flexDirection: 'column', gap: 10 }}>
                    <Field label="Keyword">
                        <input
                            autoFocus
                            value={keyword}
